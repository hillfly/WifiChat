...
public class SettingMyInfoPageActivity extends BaseActivity implements OnClickListener,
    ...
    protected void initViews() {
        ...
        mAvaterImageView = (ImageView) findViewById(R.id.setting_my_avater_img);
        ...
        mBoyRadioButton = (RadioButton) findViewById(R.id.setting_baseinfo_rb_male);
        mGirlRadioButton = (RadioButton) findViewById(R.id.setting_baseinfo_rb_female);
    ...
    protected void initEvents() {
        ...
        mAvaterImageView.setOnClickListener(this);
    }
