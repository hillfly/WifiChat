...
//		db=helper.getWritableDatabase();
		...
		values.put("status", user.getIsOnline());
		values.put("avater", user.getAvater());
		db.update(helper.getTableName(), values, "id = ?", new String[]{ String.valueOf( user.getId() ) } );
	}
...
//		db = helper.getWritableDatabase();
		...
		// orderBy)
		Cursor cursor = db.query(helper.getTableName(), new String[]{ "id", "name", "age","IMEI","sex","ip","status","avater"}, 
				"id=?", new String[]{ String.valueOf(id) }, null, null, null);
		if (cursor.moveToNext())
		{
			return new userInfo(cursor.getInt(cursor.getColumnIndex("id")),
					...
					cursor.getInt(cursor.getColumnIndex("avater")));
		}
		return null;
	}
...
//		db = helper.getWritableDatabase();
		...
		{"id", "name", "age","sex","IMEI","ip","status","avater" }, null, null, null, null, "id desc", start + "," + count);
