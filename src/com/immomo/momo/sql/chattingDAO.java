...
public class chattingDAO {
    ...
    public List<chattingInfo> getAllMessage(int sendID, int receiverID) {
        ...
        Cursor cursor = db
                .query(helper.getTableName(),
                        new String[] { "id", "sendID", "receiverID",
                                "chatting", "date" },
                        "sendID=? and receiverID=?",
                        new String[] { String.valueOf(sendID),
                                String.valueOf(receiverID) }, null, null, null);
    ...
    public chattingInfo find(int id) {
        ...
        Cursor cursor = db.query(helper.getTableName(), new String[] { "id",
                "sendID", "receiverID", "chatting", "date" }, "id=?",
    ...
    public List<chattingInfo> getScrollData(int start, int count) {
        ...
        // db = helper.getWritableDatabase();
        Cursor cursor = db.query(helper.getTableName(), new String[] { "id",
                "sendID", "receiverID", "chatting", "date" }, null, null, null,
        ...
        while (cursor.moveToNext()) {
            info.add(new chattingInfo(
                    ...
                    cursor.getString(cursor.getColumnIndex("chatting")), cursor
    ...
    public long getCount() {
        // db = helper.getWritableDatabase();
        Cursor cursor = db.query(helper.getTableName(),
